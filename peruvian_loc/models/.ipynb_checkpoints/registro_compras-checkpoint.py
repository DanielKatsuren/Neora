                    ...
                    select ai.id, 
                           ...
                           trim(
                               concat_ws('|',
                                   ...
                                   '',
                                   trim(both '0' from coalesce(substr(ai.x_clasificacion_de_bienes_y_servicios,1,2),'')),
                                   '',
                                   '',
                                   '',
                                   '',
                    ...
                    select he.id,
                           ...
                           trim(
                               concat_ws('|',
                                   ...
                                   '',
                                   trim(both '0' from coalesce(substr(he.x_clasificacion_de_bienes_y_servicios,1,2),'')),
                                   '',
                                   '',
                                   '',
                                   '',
